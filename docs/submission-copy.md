...
- Real live-data reports separated from clearly labelled sample history.
...
- Main track: complete BNB Agent Studio marketplace journey.
...
- Live capabilities currently produce read-only analysis, not mainnet trades.
- Candidate historical metrics outside the verified benchmark are labelled sample data.
